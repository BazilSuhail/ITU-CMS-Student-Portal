  ...
  return (
    <nav>
      ...
      <div className="mt-[6px] fixed hidden xsx:flex xsx:flex-col xsx:justify-between shadow-xl rounded-2xl m-[10px] xsx:items-center w-[260px] h-[98vh] bg-custom-blue p-[10px]">
        <div className="mt-[8px] w-[100%] flex">
          ...
          <div className="ml-[20px]">
            ...
            <p className="text-white  text-3xl text-center">{userName} !</p>
          </div>
      ...
      {!isXsx && isOpen && (
        ...
        <div className={`fixed z-40 flex flex-col justify-between items-center top-0 left-0 w-[270px] h-[90vh] bg-custom-blue p-[10px] shadow-xl rounded-2xl m-[10px] transition-transform transform ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>

          <button className="bg-red-500 text-white rounded-full p-[8px] ml-auto mb-[-85px]" onClick={toggleNavbar}><ImCross size={12} /></button>
          ...
          <div className="w-[100%] flex">
            ...
            <div className="ml-[20px]">
              ...
              <div className="text-white text-4xl ml-[-5px] text-center">{userName} !!</div>
            </div>
